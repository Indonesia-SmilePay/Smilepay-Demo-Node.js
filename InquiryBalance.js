...
const {ACCESS_TOKEN, BASE_URL, MERCHANT_ID, INQUIRY_BALANCE_API} = require("./Constants");

console.log("=====> inquiry Balance");

const accessToken = ACCESS_TOKEN
const merchantId = MERCHANT_ID
const endPointUrl = INQUIRY_BALANCE_API

const merchantNo = merchantId.replace("sandbox-", "S") + crypto.randomBytes(8).toString('hex');
const accountNo = "1024042914280502562"
